...
<li><a href="https://www.youtube.com/channel/UC91-ZPPRaaH98GkE10AAhcg"><i class="fa fa-youtube-play" style="font-size:30px;color:red"></i></a></li>      <li><a href="https://employers.indeed.com/messages?hl=en&co=IN"><i class="fa-brands fa-linkedin"></i></a></li>
    </ul>
  </div>
  <div class="mananav">
    <div class="container">
    ...
    <div class="container-fluid">
     <a class="navbar-brand" href="index.html"><img src="images/im.jpg" class="img-fluid" alt="..."></a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">          
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0" id="nav-list" style="color:white;">
              <li class="nav-item">
...
<div class="overview">
  <div class="inover">
    <div class="overtext">
      <a href="index.html"><span>Home</span></a>&nbsp;<i class="fa-solid fa-angle-right"></i>&nbsp;&nbsp;<a href="#"><span>Gallery</span></a>&nbsp;&nbsp;<i class="fa-solid fa-angle-right"></i>&nbsp;&nbsp;
    </div>
    <div class="company">
      <h2>Gallery</h2>
      </div>
    ...
    <div class="container servicerow">
        <div class="row usha">
           ...
           <div class="col-md-4">
            ...
            <a href="#"><img src="RetrieveImg2?id=2" width="400" height="400"></a>
         
           </div>
           <div class="col-md-4">
           
            <a href="#"><img src="RetrieveImg3?id=3" width="400" height="400"></a>
...
PreparedStatement ps = con.prepareStatement("select image from images");
...
while(rs.next())
{
	...
	%>
	<img src="data:image/jpeg;base64,<%=Base64.getEncoder().encodeToString(rs.getBytes("image"))%>" width="20%"   >
